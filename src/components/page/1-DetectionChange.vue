...
export default {
  ...
  methods: {
    //点击按钮时,触发弹出效果
		select(){
			this.selectImg1=this.dataImageList[this.a].coverImg;
			this.selectImg2=this.dataImageList[this.b].coverImg;
			...
			axios.post('http://192.168.31.18:8081/changedetection/' ,
						{
							'before': this.selectImg1,
							'after':this.selectImg2,
